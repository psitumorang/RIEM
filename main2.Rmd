---
title: "RIEM MAIN Period 2"
subtitle: "(Inspection Period: 10/01/2020 - 09/30/2021)"
date: "2024-09-04"
output:
  html_document:
    code_folding: hide
...
Year 0: 10/01/2019 - 09/30/2020
Year 1: 10/01/2020 - 09/30/2021 (Period of analysis)
Year 2: 10/01/2021 - 09/30/2022
...
# Year 0: 10/01/2018 - 09/30/2019 -> MCMIS191227
# Year 1: 10/01/2019 - 09/30/2020 (Period of analysis) -> MCMIS201218
# Year 2: 10/01/2020 - 09/30/2021 -> MCMIS220325
...
FROM MCMIS220325.CARRIER_DRIVER_COUNT
WHERE STATUS_CODE = 'A'
...
FROM MCMIS220325.ISSDP_FINAL NATURAL JOIN MCMIS220325.PRI_RUNINFO
WHERE PRZATION_RUNDATE BETWEEN TO_DATE('01/10/2016', 'DD/MM/YYYY') AND TO_DATE('30/09/2021', 'DD/MM/YYYY') ),
...
FROM MCMIS220325.INSPECTION NATURAL JOIN CTE1
WHERE INSP_DATE BETWEEN TO_DATE('01/10/2020', 'DD/MM/YYYY') AND TO_DATE('30/09/2021', 'DD/MM/YYYY')
    AND DOT_NUMBER IS NOT NULL
...
# crash rate 2023
df1 <- df1 %>% mutate(crash_rate =
df1$CRASH_COUNT/df1$PU_COUNT)
...
write_csv(summary, 'C:\\Users\\Philip.Situmorang\\Desktop\\RIEM\\1 - Main\\Period 2\\summary_slopes_period2.csv')
```
...
write_csv(sensitivity, 'C:\\Users\\Philip.Situmorang\\Desktop\\RIEM\\1 - Main\\Period 2\\sensitivity_period2.csv')
```
